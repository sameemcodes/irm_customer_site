(function ($) {
	...
	function creat_new_customer(input) {
		...
		var Cust_region = $(input[3]).val()
		var Cust_prm_cntct = $(input[4]).val()
		var Cust_prm_cntct_email = $(input[5]).val()
		var Engmnt_type = $(input[6]).val()
		var Cust_emp_cnt = $(input[7]).val()
		var Cust_prm_cntct_desg = $(input[8]).val()
